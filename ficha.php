...
<head>
    ...
    <link rel="stylesheet" href="assets/css/ficha.css?v=20260501x" />
...
<body>
    ...
    <script src="assets/js/ficha.js?v=20260501p"></script>
    ...
    <script src="assets/js/ancestralidade-picker.js?v=20260502f"></script>
